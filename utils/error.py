...
class DecafRedefinedFuncError(Exception):
    def __init__(self, name: str) -> None:
        super().__init__("Semantic error: redefined function '%s'" % name)


class DecafVarShadowFuncError(Exception):
    def __init__(self, name: str) -> None:
        super().__init__("Semantic error: var shadow function '%s'" % name)


class DecafWrongArgsNumError(Exception):
    def __init__(self, name: str) -> None:
        super().__init__("Semantic error: wrong args num function '%s'" % name)
