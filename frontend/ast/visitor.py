...
class Visitor(Protocol[T, U]):  # type: ignore
    def visitOther(self, node: Node, ctx: T, func=False) -> None:
        return None
    ...
    def visitBlock(
        self, that: Block, ctx: T, func=False
    ) -> Optional[Sequence[Optional[U]]]:
        return self.visitOther(that, ctx)

    def visitParam(self, that: Param, ctx: T) -> Optional[U]:
        return self.visitOther(that, ctx)

    def visitParamList(self, that: ParamList, ctx: T) -> Optional[U]:
        return self.visitOther(that, ctx)

    def visitFunction(self, that: Function, ctx: T) -> Optional[U]:
        return self.visitOther(that, ctx)

    def visitArgList(self, that: ArgList, ctx: T) -> Optional[U]:
        return self.visitOther(that, ctx)
    ...
    def visitSubscription(self, that: Subscription, ctx: T) -> Optional[U]:
        return self.visitOther(that, ctx)

    def visitArrayInitList(self, that: ArrayInitList, ctx: T) -> Optional[U]:
        return self.visitOther(that, ctx)
